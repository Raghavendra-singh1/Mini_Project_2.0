        ...
        <div>
            <ul id="navbar">
                ...
                <li><a href="contact.html">Contact</a></li>
                 ...
                 <li><a id="login-btn" href="http://localhost/miniproject2/register.php">Sign up</a></li>
                <li><a  href="http://localhost/miniproject2/login.php">Login</a></li> 
    ...
    <footer class="section-p1">
        <div class="col">
            ...
            <div class="follow">
                <h4>Follow us</h4>
                <div class="icon">
                   <a href="https://www.instagram.com/"> <i class="fab fa-facebook-f"></i>
